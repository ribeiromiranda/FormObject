...
class FormTipoPessoa extends \FormObject\Form {
    protected function _init () {
        $this->addProperty(new \Zend_Form_Element_Text(array('name' => 'nome', 'label' => 'Nome')));
        $this->addProperty(new \Zend_Form_Element_Text(array('name' => 'documento', 'label' => 'Documento')));
    }
}