...
class DateTimeTzType extends Type {
    ...
    public function convertToViewValue($value) {
        return ($value !== null) ? $value->format(self::getFormatDefault()->getDateTimeTzFormatString()) : null;
    }
    ...
    public function convertToPHPValue($value) {
        ...
        $val = \DateTime::createFromFormat(self::getFormatDefault()->getDateTimeTzFormatString(), $value);
        if (! $val) {
