...
class DateType extends Type {
    ...
    public function convertToViewValue($value) {
        return ($value !== null) ? $value->format(self::getFormatDefault()->getDateFormatString()) : null;
    }
    ...
    public function convertToPHPValue($value) {
        ...
        $val = \DateTime::createFromFormat('!' . self::getFormatDefault()->getDateFormatString(), $value);
        if (! $val) {
